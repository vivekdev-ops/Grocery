  ...
  return (
    <AnimatePresence mode="wait">
      <Routes location={location} key={location.pathname}>
       ...
       <Route path="/account/wishlist"    element={<PageWrap><WishlistPage /></PageWrap>} />
        <Route path="/wishlist"            element={<PageWrap><WishlistPage /></PageWrap>} />
        <Route path="/account/address"     element={<PageWrap><AddressBookPage /></PageWrap>} />
        <Route path="/about"               element={<AboutPage />} />
        <Route path="/signup" element={<PageWrap><CustomerAuth /></PageWrap>} />
      </Routes>
    </AnimatePresence>
  );
}
